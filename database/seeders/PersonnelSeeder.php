    ...
    public function run(): void
    {
        DB::table('personnels')->insert([
            [
                ...
                'position_id' => 18, // Ensure this matches an existing job_id
                'appointment' => 'regular',
            ...
            [
                ...
                'school_id' => 1, // Ensure this matches an existing school_id
                'position_id' => 48, // Ensure this matches an existing job_id
                'appointment' => 'regular',
                'fund_source' => 'nationally funded',
                'salary_grade' => '19',
                'step' => '3',
            ...
            [
                ...
                'school_id' => 1, // Ensure this matches an existing school_id
                'position_id' => 26, // Ensure this matches an existing job_id
                'appointment' => 'regular',
                'fund_source' => 'nationally funded',
                'salary_grade' => '20',
                'step' => '6',
            ...
            [
                ...
                'personnel_id' => '10757',
                'school_id' => 1, // Ensure this matches an existing school_id
                'position_id' => 30, // Ensure this matches an existing job_id
                'appointment' => 'regular',
                'fund_source' => 'nationally funded',
                'salary_grade' => '19',
                'step' => '3',
            ...
            [
                ...
                'school_id' => 1, // Ensure this matches an existing school_id
                'position_id' => 39, // Ensure this matches an existing job_id
                'appointment' => 'regular',
                'fund_source' => 'pta',
                'salary_grade' => '19',
                'step' => '3',
