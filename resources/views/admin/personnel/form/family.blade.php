<div class="mx-auto pt-3 pb-10 px-5">
    ...
    <div class="mt-5" x-data='childrenFields()'>
        ...
        <div class="mt-3 flex space-x-3 items-center">
            <div class="w-full">
                <button @click.prevent="addNewField()" class="py-2 w-full text-base bg-primary text-white tracking-wide font-medium rounded hover:bg-[#334979] hover:text-white duration-300 focus:outline-none">Add</button>
            </div>
        </div>
