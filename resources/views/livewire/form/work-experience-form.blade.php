                            ...
                            @foreach ($old_work_experiences as $index => $old_work_experience)
                                <div class="mb-2 px-3 w-full space-x-3 h-40 border border-gray-200 rounded focus:outline-none">
                                    ...
                                    <div class="mb-3 flex space-x-2">
                                        ...
                                        <div class="w-2/12">
                                            <x-input id="is_gov_service_{{ $index }}" type="text" wire:model="old_work_experiences.{{ $index }}.is_gov_service" name="old_work_experiences[{{ $index }}][is_gov_service]" label="Govm't Service (Yes/No)" readonly/>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
