...
<html>
    ...
    <table>
        ...
        <tr>
            ...
            <td>Region</td>
            <td style="border: 1px solid #000000;">{{ $school->region }}</td>
        ...
        <tr>
            ...
            <td colspan="5" style="border: 1px solid #000000;">{{ $school->district }}</td>
    ...
    <table>
        ...
        <tr>
            <td style="border: 1px solid #000000;">{{ $personnel->personnel_id }}</td>
            <td style="border: 1px solid #000000;">{{ htmlspecialchars($personnel->fullName()) }}</td>
            <td style="border: 1px solid #000000;">{{ htmlspecialchars($personnel->sex) }}</td>
            <td colspan="2" style="border: 1px solid #000000;">{{ htmlspecialchars('fund_source') }}</td>
            <td style="border: 1px solid #000000;">{{ htmlspecialchars($personnel->job_title) }}</td>
            <td style="border: 1px solid #000000;">{{ htmlspecialchars($personnel->job_status) }}</td>
            <td rowspan="1" style="border: 1px solid #000000;">{{ htmlspecialchars('degree') }}</td>
            <td rowspan="1" colspan="2" style="border: 1px solid #000000;">{{ htmlspecialchars('major') }}</td>
            <td rowspan="1" colspan="2" style="border: 1px solid #000000;">{{ htmlspecialchars('minor') }}</td>
            <td style="border: 1px solid #000000;">{{ htmlspecialchars('subs_taught') }}</td>
            <td rowspan="1" style="border: 1px solid #000000;">{{ htmlspecialchars(__('moday)')) }}</td>
            <td rowspan="1" style="border: 1px solid #000000;">{{ htmlspecialchars('00:00') }}</td>
            <td rowspan="1" style="border: 1px solid #000000;">{{ htmlspecialchars('00:00') }}</td>
            <td rowspan="1" style="border: 1px solid #000000;">{{ htmlspecialchars('00:00') }}</td>
            <td colspan="2" style="border: 1px solid #000000;">{{ htmlspecialchars('remarks') }}</td>
        </tr>
        @endforeach
        </tbody>
    </table>
