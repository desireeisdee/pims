    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3 justify-end">
                <a href="{{ route('schools.export', $school->id) }}" class="w-24 rounded-md px-5 py-2 bg-primary text-white tracking-wider hover:hover:bg-primary-hover hover:scale-105 duration-100">
                    Export
                </a>
