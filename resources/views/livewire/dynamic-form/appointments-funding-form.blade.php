<div class="py-3" x-data='appointmentFields({{ isset($school) && $school->appointments_fundings()->count() > 0 ? 1 : 0 }})'>
    ...
    <div class="mt-3 flex space-x-3 items-center">
        <div class="w-full">
            <button @click.prevent="addNewField()" class="py-2 w-full text-base bg-primary text-white tracking-wide font-medium rounded hover:bg-[#334979] hover:text-white duration-300 focus:outline-none">New Appointments Funding</button>
        </div>
    </div>
