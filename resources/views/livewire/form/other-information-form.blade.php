                    ...
                    <div>
                        ...
                        <div class="mt-3">
                            @if ($old_skills != null)
                                ...
                                @endforeach
                            @else
                                <p class="mt-1 w-full py-2.5 font-medium text-xs text-center border border-gray-200 bg-gray-50 drop-shadow-sm">No Record Found</p>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div class="mt-3">
                            @if ($old_associations != null)
                                ...
                                @endforeach
                            @else
                                <p class="mt-1 w-full py-2.5 font-semibold text-xs text-center border border-gray-200 bg-gray-50 drop-shadow-sm">No Record Found</p>
                            @endif
                        </div>
                    </div>
                </div>
