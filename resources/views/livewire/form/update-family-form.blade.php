<div class="mx-auto pt-3 pb-10 px-5">
    ...
    <div class="m-0 mb-4 p-0 flex space-x-3 justify-end">
        <x-button wire:click.prevent="store" label="Save" class="px-5 bg-primary font-semibold text-xs text-white uppercase tracking-widest hover:hover:bg-primary-hover"/>
    </div>
</div>
