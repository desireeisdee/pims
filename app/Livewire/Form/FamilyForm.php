...
class FamilyForm extends PersonnelNavigation
{
    ...
    protected $rules = [
        'fathers_first_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'fathers_middle_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'fathers_last_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'fathers_name_ext' => 'nullable',
        'mothers_first_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'mothers_middle_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'mothers_last_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'spouse_first_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'spouse_middle_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'spouse_last_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        ...
        'old_children.*.first_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'old_children.*.middle_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'old_children.*.last_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'old_children.*.name_ext' => 'nullable',
        'old_children.*.date_of_birth' => 'required|date',
        'new_children.*.first_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'new_children.*.middle_name' => 'required|regex:/^[a-zA-Z\s]+$/',
        'new_children.*.last_name' => 'required|regex:/^[a-zA-Z\s]+$/',
